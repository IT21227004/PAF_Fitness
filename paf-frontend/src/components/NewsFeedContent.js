...
function NewsFeedContent() {
    ...
    const storeFollowingWorkoutStatus = useSelector((state) => state.followingWorkoutStatusReducer.followingWorkoutStatuss);
    const storeFollowingWorkoutPlan = useSelector((state) => state.followingWorkoutPlanReducer.followingWorkoutPlans);
